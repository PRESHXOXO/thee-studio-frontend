...
export function FeatureCard({ eyebrow, title, copy, cta, onCta, style }) {
  return (
    <div style={{
      background: 'radial-gradient(circle at 82% 36%, rgba(212,175,90,0.14), transparent 34%), linear-gradient(135deg, rgba(28,26,36,0.94), rgba(21,20,28,0.85))',
      border: '1px solid rgba(212,175,90,0.28)', borderRadius: 'var(--radius-xl)',
      padding: 30, position: 'relative', overflow: 'hidden', minHeight: 220, ...style,
    }}>
      <div style={{ position: 'absolute', right: -34, top: 30, width: 170, height: 170, borderRadius: '50%', background: 'rgba(212,175,90,0.06)', border: '1px solid rgba(212,175,90,0.20)' }} />
      <div style={{ position: 'absolute', right: 22, top: 44, width: 92, height: 92, borderRadius: '50%', background: 'var(--grad-rose)', border: '1px solid rgba(212,175,90,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
