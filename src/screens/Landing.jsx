    ...
    <section style={{
      ...
      <div style={{
        ...
        <div style={{ width: 180, background: 'var(--white)', borderRight: '1px solid var(--border)', padding: '20px 12px', flexShrink: 0 }}>
          ...
          {['Studio', 'Cast', 'New Creator', 'Thee Director', 'Scenes'].map((item, i) => (
            <div key={item} style={{
...
function FeaturesSection() {
  const features = [
    ...
    { icon: '◇', title: 'New Creator', desc: 'Build a new creator\'s look — on-brand lifestyle content, campaign shots, and editorial imagery, all identity-consistent.' },
    ...
    { icon: '◎', title: 'Cast Library', desc: 'Save, organize, and reuse creators across every project. Your roster, always ready.' },
  ];
